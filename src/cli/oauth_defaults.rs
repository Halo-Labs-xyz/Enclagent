...
//!
//! - **Compile time**: Set ENCLAGENT_GOOGLE_CLIENT_ID / ENCLAGENT_GOOGLE_CLIENT_SECRET
...
const GOOGLE_CLIENT_ID: &str = match option_env!("ENCLAGENT_GOOGLE_CLIENT_ID") {
    Some(v) => v,
    None => "564604149681-efo25d43rs85v0tibdepsmdv5dsrhhr0.apps.googleusercontent.com",
};
const GOOGLE_CLIENT_SECRET: &str = match option_env!("ENCLAGENT_GOOGLE_CLIENT_SECRET") {
    Some(v) => v,
...
mod tests {
    ...
    fn test_landing_html_success_contains_key_elements() {
        ...
        assert!(html.contains("Enclagent"));
