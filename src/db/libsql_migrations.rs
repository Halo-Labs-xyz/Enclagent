...
CREATE TABLE IF NOT EXISTS module_catalog (
    ...
    optional_addon INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_frontdoor_sessions_user_wallet
    ON frontdoor_sessions(user_id, wallet_address);
CREATE INDEX IF NOT EXISTS idx_frontdoor_sessions_status
    ON frontdoor_sessions(status);
...
CREATE INDEX IF NOT EXISTS idx_verification_artifacts_user
    ON verification_artifact_links(user_id);
CREATE INDEX IF NOT EXISTS idx_verification_artifacts_workspace
    ON verification_artifact_links(workspace_id);
CREATE INDEX IF NOT EXISTS idx_verification_artifacts_module
    ON verification_artifact_links(module_id);
