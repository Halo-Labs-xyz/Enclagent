...
use crate::tools::hyperliquid::{HYPERLIQUID_EXECUTE_TOOL_NAME, HyperliquidExecuteTool};
...
impl ToolRegistry {
    ...
    /// echo, time, json, http, hyperliquid_execute. Use this when `allow_local_tools = false` and
