...
impl SseManager {
    ...
    /// Maximum number of concurrent SSE/WebSocket connections supported.
    pub fn max_connections(&self) -> u64 {
        self.max_connections
    }

    /// Remaining connection slots before the manager starts rejecting new clients.
    pub fn remaining_capacity(&self) -> u64 {
        self.max_connections
            .saturating_sub(self.connection_count.load(Ordering::Relaxed))
    }
