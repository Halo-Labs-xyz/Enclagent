...
pub struct ChannelCapabilitiesFile {
    ...
    /// Host compatibility handshake metadata.
    #[serde(default)]
    pub host_compatibility: Option<HostCompatibilitySchema>,
...
/// Channel-host compatibility metadata.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct HostCompatibilitySchema {
    /// Expected WIT world name.
