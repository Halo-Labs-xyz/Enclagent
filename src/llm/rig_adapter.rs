//! Generic adapter that bridges rig-core's `CompletionModel` trait to Enclagent's `LlmProvider`.
//!
...
/// Convert Enclagent messages to rig-core format.
///
...
/// Convert Enclagent tool definitions to rig-core format.
///
...
/// Convert Enclagent tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to Enclagent types
            _ => {}
        }
    }
