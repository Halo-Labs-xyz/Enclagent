...
/// Supported verification providers for WS-10 proof jobs.
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum VerificationJobProvider {
    EigenCloud,
    EigenCompute,
}

/// Secret reference used for verification job submission.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct VerificationJobCredentialRef {
