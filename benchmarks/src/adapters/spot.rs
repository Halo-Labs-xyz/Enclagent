...
impl BenchSuite for SpotSuite {
    ...
    fn additional_tools(&self) -> Vec<Arc<dyn enclagent::tools::Tool>> {
        vec![
            Arc::new(enclagent::tools::builtin::ShellTool::new()),
            Arc::new(enclagent::tools::builtin::ReadFileTool::new()),
            Arc::new(enclagent::tools::builtin::WriteFileTool::new()),
            Arc::new(enclagent::tools::builtin::ListDirTool::new()),
            Arc::new(enclagent::tools::builtin::ApplyPatchTool::new()),
        ]
    }
}
