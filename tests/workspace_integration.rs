...
//! Set DATABASE_URL=postgres://localhost/enclagent_test

use std::sync::Arc;

use enclagent::workspace::{MockEmbeddings, SearchConfig, Workspace, paths};

fn get_pool() -> deadpool_postgres::Pool {
    let database_url = std::env::var("DATABASE_URL")
        .unwrap_or_else(|_| "postgres://localhost/enclagent_test".to_string());
