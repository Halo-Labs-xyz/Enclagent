...
use enclagent::channels::Channel;
use enclagent::channels::wasm::{
...
use enclagent::pairing::PairingStore;
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = enclagent::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use enclagent::channels::wasm::{ChannelHostState, EmittedMessage};
