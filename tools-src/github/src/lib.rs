//! GitHub WASM Tool for Enclagent.
//!
...
//! `enclagent secret set github_token <token>`
//!
...
fn get_github_token() -> Result<String, String> {
    ...
    Err("GitHub token not found in secret store. Set it with: enclagent secret set github_token <token>. \
...
fn github_request(method: &str, path: &str, body: Option<String>) -> Result<String, String> {
    ...
    let headers = serde_json::json!({
        ...
        "User-Agent": "Enclagent-GitHub-Tool"
    });
