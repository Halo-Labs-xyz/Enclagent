# Enclagent ↔ OpenClaw Feature Parity Matrix

This document tracks feature parity between Enclagent (Rust implementation) and OpenClaw (TypeScript reference implementation). Use this to coordinate work across developers.
...
| Channel | OpenClaw | Enclagent | Priority | Notes |
|---------|----------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | - | Ratatui-based TUI |
| HTTP webhook | ✅ | ✅ | - | axum with secret validation |
| REPL (simple) | ✅ | ✅ | - | For testing |
| WASM channels | ❌ | ✅ | - | Enclagent innovation |
...
| Feature | OpenClaw | Enclagent | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `enclagent pairing list/approve`, host APIs |
...
| Command | OpenClaw | Enclagent | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Feature | OpenClaw | Enclagent | Notes |
|---------|----------|----------|-------|
| Pi agent runtime | ✅ | ➖ | Enclagent uses custom runtime |
...
| Provider | OpenClaw | Enclagent | Priority | Notes |
|----------|----------|----------|----------|-------|
...
| Tinfoil | ❌ | ✅ | - | Private inference provider (Enclagent-only) |
...
| Feature | OpenClaw | Enclagent | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Workspace-relative install | ✅ | ✅ | ~/.enclagent/tools/ |
...
| Hot-reload | ✅ | ❌ | |
| Legacy migration | ✅ | ➖ | |
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.enclagent/` | |
...
| Gemini embeddings | ✅ | ❌ | |
| Local embeddings | ✅ | ❌ | |
| SQLite-vec backend | ✅ | ❌ | Enclagent uses PostgreSQL |
...
| DM pairing verification | ✅ | ✅ | enclagent pairing approve, host APIs |
| Allowlist/blocklist | ✅ | 🚧 | allow_from + pairing store |
...
| WASM sandbox | ❌ | ✅ | Enclagent innovation |
...
- ✅ DM pairing (enclagent pairing list/approve, host APIs)
- ✅ WASM tool sandbox
...
Enclagent intentionally differs from OpenClaw in these ways:
...
7. **Tinfoil private inference**: Enclagent-only provider for private/encrypted inference
